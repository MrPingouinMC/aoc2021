...
#execute if score FOUND_SOME VAR matches 2 if data storage buf stack[0].main run tellraw @a ["sum ", {"score":{"objective":"VAR","name":"DAY"}}, "  ", {"score":{"objective":"VAR","name":"VAL"}}, "      ", {"score":{"objective":"PUF","name":"VAL"}}]
