...
execute if score ID VAR matches 4 run function aoc:sol/day16/to_val
execute if score ID VAR matches 4 run data modify storage buf4 data append value -1
execute if score ID VAR matches 4 run execute store result storage buf4 data[-1] int 1 run scoreboard players get VAL VAR
execute unless score ID VAR matches 4 run function aoc:sol/day16/read_packet_operation
