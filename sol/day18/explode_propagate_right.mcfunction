...
execute if score CUR VAR matches 0.. run scoreboard players operation CUR VAR += B VAR 
...
execute if score BSIZE VAR matches 1.. run function aoc:sol/day18/explode_propagate_right
